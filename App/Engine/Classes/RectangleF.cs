...
namespace WtfApp.Classes
{
    ...
    public struct RectangleF
    {
        ...
        private static readonly RectangleF _empty = new RectangleF();
        private static readonly RectangleF _minMax = new RectangleF(Vector2.One * float.MinValue, Vector2.One * float.MaxValue);
        ...
        public RectangleF(double x, double y, double width, double height)
        {
            Min.X = (float)x;
            Min.Y = (float)y;
            Max.X = (float)x + (float)width;
            Max.Y = (float)y + (float)height;
        }
